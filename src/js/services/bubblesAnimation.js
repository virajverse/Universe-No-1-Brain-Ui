...
class BubblesAnimation {
    ...
    initAnimation() {
        ...
        for (let i = 0; i < particles - (this.memorySelected.length * 3); i += 1) {
            ...
            // Populate matching colors for memory bubbles: only Purple, Blue, Cyan (Layer 8)
            const bubbleColor = new THREE.Color();
            const modColor = r % 3;
            if (modColor === 0) {
                bubbleColor.setHex(0x006DFF); // Blue
            } else if (modColor === 1) {
                bubbleColor.setHex(0xBD00FF); // Purple
            } else {
                bubbleColor.setHex(0x00E5FF); // Cyan
            }
            ...
            uniforms:
                    {
                        ...
                        glowColor: { type: 'c', value: new THREE.Color(0xBD00FF) },
                        ...
                        uStateColor: { type: 'c', value: new THREE.Color(0x00F2FE) },
                    },
